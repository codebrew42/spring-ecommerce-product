...
class Station(
    ...
    var name: String,
  //  @ManyToOne //ver1
    @ManyToOne(cascade = [CascadeType.PERSIST]) //ver2
...
Hibernate:
    ...
    values
        (?, default)
2025-07-31T12:01:21.158+02:00 TRACE 39880 --- [spring-ecommerce] [    Test worker] org.hibernate.orm.jdbc.bind              : binding parameter (1:VARCHAR) <- [line1]
Hibernate:
    insert
    into
        "station info"
        (line_id, station_name, id)
    values
        (?, ?, default)
 ...
 Hibernate:
    ...
    values
        (?, default)
2025-07-31T12:03:04.105+02:00 TRACE 39924 --- [spring-ecommerce] [    Test worker] org.hibernate.orm.jdbc.bind              : binding parameter (1:VARCHAR) <- [line1]
Hibernate:
    insert
    into
        "station info"
